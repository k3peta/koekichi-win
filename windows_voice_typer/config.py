...
DEFAULT_CONFIG: dict[str, Any] = {
    ...
    "suppress_alt_menu_shortcut": True,
    "input_listener_backend": "low_level",
    ...
    "low_activity_guard_enabled": True,
    "low_activity_peak_threshold": 0.008,
    "low_activity_rms_threshold": 0.0015,
    "low_activity_min_active_seconds": 0.12,
    "low_activity_min_record_seconds": 0.20,
    "hud_topmost": True,
    "whisper_model": "small",
    "whisper_device": "cpu",
    ...
    "whisper_prompt": "",
    "whisper_auto_prompt_hints_enabled": True,
    "whisper_hotwords_enabled": False,
    "whisper_hint_max_terms": 40,
    "whisper_hotwords_max_terms": 20,
