...
- 録音中: 入力欄付近に小さいHUDが表示され、音量バーが動きます。
...
- モデルが未ダウンロードの場合は、タスクトレイの Koe Kichi アイコンから「モデルセットアップ...」を実行できます。
- 文字起こし時にモデル未準備らしいエラーが出た場合も、声吉が自動でモデルセットアップを開始します。
